...
namespace MemoryMatchingGame
{
    public partial class GameWindow : Form
    {
        //Variabile
        //int score = 0; //Scorul
        Random location = new Random(); //Selecteaza o valoare aleatorie din lista X și Y și atribuie o noua locatie fiecarui card
        List<Point> points = new List<Point>(); //Lista care tine punctele cardurilor
        bool again = false; //Joaca din nou sau nu
        PictureBox PendingImage1; //Tine prima carte intoarsa in aceasta variabila
        PictureBox PendingImage2;//----- a doua -------------------------------
